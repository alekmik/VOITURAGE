...
namespace Voiturage.Controllers
{
    public class SearchController : Controller
    {
        ...
        public IActionResult Index(SearchViewModel search)
        {
            ...
            {
                return View(_db.Trajets.Include(x=>x.Chauffeur).Where(x=>x.IdVilleDepart==search.IdVilleDepart && x.IdVilleArrivee==search.IdVilleArrivee && x.HeureDepart.Date==search.DateDepart.Date && x.Place>=search.PlacesRequises));
            }
